        ...
        <div className="fixed top-4 inset-x-4 z-50 flex justify-center pointer-events-none">
            ...
            >
                ...
                <nav className="hidden md:flex items-center gap-0.5">
                    <Button variant="ghost" size="sm" asChild className="rounded-full text-white/50 hover:text-white hover:bg-white/8 text-[13px]">
                ...
                <Button size="sm" asChild className="rounded-full bg-white text-gray-900 hover:bg-gray-100 text-[13px] px-4 font-semibold shadow-none">
