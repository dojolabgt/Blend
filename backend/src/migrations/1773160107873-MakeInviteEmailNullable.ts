...
export class MakeInviteEmailNullable1773160107873 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "workspace_connections" ALTER COLUMN "invite_email" DROP NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "workspace_connections" ALTER COLUMN "invite_email" SET NOT NULL`);
    }
