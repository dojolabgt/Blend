...
export class AddServicesAndClients1772476808768 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "services" ADD CONSTRAINT "FK_4658855ea068f1d53fa0be188e3" FOREIGN KEY ("workspaceId") REFERENCES "workspaces"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "clients" ADD CONSTRAINT "FK_5a994c441a4612d4a35e0927da5" FOREIGN KEY ("workspaceId") REFERENCES "workspaces"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "clients" DROP CONSTRAINT "FK_5a994c441a4612d4a35e0927da5"`);
        await queryRunner.query(`ALTER TABLE "services" DROP CONSTRAINT "FK_4658855ea068f1d53fa0be188e3"`);
