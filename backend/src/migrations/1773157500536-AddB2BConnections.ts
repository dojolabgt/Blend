...
export class AddB2BConnections1773157500536 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "workspace_connections" ADD CONSTRAINT "FK_86c10824b8da6087d848c8cb61b" FOREIGN KEY ("inviter_workspace_id") REFERENCES "workspaces"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "workspace_connections" ADD CONSTRAINT "FK_94dd32508a96f6cce00a7674aae" FOREIGN KEY ("invitee_workspace_id") REFERENCES "workspaces"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "deal_collaborators" ADD CONSTRAINT "FK_6c14de89761aec694b9d8dd9997" FOREIGN KEY ("deal_id") REFERENCES "deals"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "deal_collaborators" ADD CONSTRAINT "FK_66e2f877f3a3b54362de3defd34" FOREIGN KEY ("workspace_id") REFERENCES "workspaces"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "deal_collaborators" DROP CONSTRAINT "FK_66e2f877f3a3b54362de3defd34"`);
        await queryRunner.query(`ALTER TABLE "deal_collaborators" DROP CONSTRAINT "FK_6c14de89761aec694b9d8dd9997"`);
        await queryRunner.query(`ALTER TABLE "workspace_connections" DROP CONSTRAINT "FK_94dd32508a96f6cce00a7674aae"`);
        await queryRunner.query(`ALTER TABLE "workspace_connections" DROP CONSTRAINT "FK_86c10824b8da6087d848c8cb61b"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."deal_collaborators_role_enum"`);
        await queryRunner.query(`DROP TABLE "workspace_connections"`);
        await queryRunner.query(`DROP TYPE "public"."workspace_connections_status_enum"`);
    }
