...
export class ClientLocalizationFields1772510000000
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "clients" ADD "address" jsonb`,
        );
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "clients" DROP COLUMN "address"`);
        await queryRunner.query(`ALTER TABLE "clients" DROP COLUMN "taxIdentifiers"`);
        ...
        await queryRunner.query(
            `DROP TYPE "public"."clients_type_enum"`,
        );
    }
}
